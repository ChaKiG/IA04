...
public class Constants {
	...
	public static final Integer 	CAPACITY 	= 10;			//points de capacité à répartir chez l'insecte entre déplacement, perception et charge 
	public static final Integer 	MAX_FOOD 	= 5;			//maximum de nourriture sur une cellule 
	public static final Integer 	FOOD_ENERGY = 3;			//nombre de points d'énergie donnés par 1 point de nourriture 
}
